...
export CLUSTER_NAME=cluster-1                                   # NKP cluster name. When using NKP Pro/Ultimate, this name is used to generate the license key
...
export LB_IP_RANGE=10.38.1.13-10.38.1.16                                            # Load balancer IP range - Ex: 10.42.236.204-10.42.236.204
export CONTROL_PLANE_ENDPOINT_IP=10.38.1.12                               # Kubernetes VIP. Must be in the same subnet as the VMs - Ex: 10.42.236.203
